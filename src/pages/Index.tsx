    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4">
      ...
      <div className="mb-12 flex flex-col items-center text-center">
        ...
        <h1 className="text-3xl font-extrabold tracking-tight text-foreground sm:text-4xl">
          Smart Solar <span className="text-primary">por Indução</span>
        </h1>
        <p className="mt-3 max-w-md text-sm text-muted-foreground leading-relaxed">
          Estação de recarga sem fio para veículos elétricos, alimentada por energia solar.
      ...
      <div className="grid w-full max-w-lg gap-4 sm:grid-cols-2">
        <button
          ...
          className="group flex flex-col items-center gap-4 rounded-2xl bg-card p-8 shadow-card transition-all hover:shadow-card-hover hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-primary"
        >
        ...
        <button
          ...
          className="group flex flex-col items-center gap-4 rounded-2xl bg-card p-8 shadow-card transition-all hover:shadow-card-hover hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-secondary"
        >
      ...
      <p className="mt-10 text-[11px] text-muted-foreground">
        Protótipo acadêmico — Energia limpa para mobilidade elétrica ☀️
      </p>
    </div>
  );
};
